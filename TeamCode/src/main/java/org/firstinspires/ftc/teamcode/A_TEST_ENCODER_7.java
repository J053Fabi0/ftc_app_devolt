...
@Autonomous(name="Alianza Roja. Lado A.", group="Gaia")

public class A_TEST_ENCODER_7 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(TURN_SPEED,10,-10,.9); //Gira para voltear a los pilares
