...
@Autonomous(name="Alianza Azul. Lado B.", group="Gaia")

public class A_TEST_ENCODER_4 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(.2,10,10,.7);//Derecho
        encoderDrive(.2,-10,10,.7);//Izquierda
        encoderDrive(.3,10,10,.6);//derecho
        encoderDrive(.2,-10,10,.7);//Izquierdo
